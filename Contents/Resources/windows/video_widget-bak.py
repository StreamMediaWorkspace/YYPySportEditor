...
class VideoWidget(QWidget):
    ...
    def mousePressEvent(self, event):
        ...
        #get_app().updates.ignore_history = True#todo ===========
    ...
    def mouseReleaseEvent(self, event):
        ...
        #get_app().updates.ignore_history = False#todo ===========

        # Add final update to undo/redo history
        #if self.original_clip_data:#todo ===========
    ...
    def mouseMoveEvent(self, event):
        ...
        if self.transforming_clip:
            ...
            playhead_position = float(self.win.preview_thread.current_frame) / fps_float
            ...
            playhead_position_frame = float(self.win.preview_thread.current_frame)
